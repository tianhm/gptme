...
def normalize_model(model: str) -> str:
    ...
    replacements = {
        ...
        "openai-subscription/gpt-5.6-sol": "GPT-5.6 Sol (sub)",
        "openai-subscription/gpt-6-astra": "GPT-6 Astra (sub)",
        "grok-subscription/grok-4.6": "Grok 4.6 (sub)",
        "xai/grok-4.6": "Grok 4.6",
        "openrouter/deepseek/deepseek-v4.1-flash": "DeepSeek V4.1 Flash (OR)",
        "openrouter/deepseek/deepseek-v4-flash-0731": "DeepSeek V4 Flash 0731 (OR)",
        "openrouter/deepseek/deepseek-v4-pro-0813": "DeepSeek V4 Pro 0813 (OR)",
        "openrouter/z-ai/glm-5.3-flash": "GLM 5.3 Flash (OR)",
