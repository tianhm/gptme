...
- ``default_tool_format`` is set to ``tool`` on 106 of the 125 models in the
...
- ``supports_parallel_tool_calls`` is set on 65 entries: the Claude Opus/Sonnet
...
- ``supports_strict_tools`` is set on 26 entries: the OpenAI models (GPT-4o/4.1/5/6
