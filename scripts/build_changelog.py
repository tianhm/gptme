...
class Commit:
    ...
    def parse_type(self) -> tuple[str, str] | None:
...
def _resolve_email(email: str) -> str | None:
...
def get_all_contributors() -> set[str]:
    ...
    resolved_emails = {email for email_set in usernames.values() for email in email_set}
